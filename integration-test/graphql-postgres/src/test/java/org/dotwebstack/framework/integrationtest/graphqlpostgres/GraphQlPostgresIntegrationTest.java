...
// is("00000000040000000100000000014017eac6e4232933404a1bcbd2b403c4"));
// }
//
// @Test
 ...
 *
 * getNestedObject(data, BEER); getNestedObject(data, BREWERY); getNestedObjects(data, BREWERIES);
 * getNestedObjects(data, BEERS);
 */
