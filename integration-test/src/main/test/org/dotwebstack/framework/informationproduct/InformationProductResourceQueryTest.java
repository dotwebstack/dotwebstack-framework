...
public class InformationProductResourceQueryTest {
  ...
  public void setUp() throws IOException {
    ...
    informationProductLoader = new InformationProductResourceProvider(configurationBackend, backendResourceProvider);
  }
  ...
  public void loadInformationProduct() {
    ...
    // Act
    informationProductLoader.loadResources();
