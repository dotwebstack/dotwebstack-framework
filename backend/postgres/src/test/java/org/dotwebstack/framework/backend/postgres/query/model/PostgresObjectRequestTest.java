...
// postgresObjectRequest.addFields(filterCriteria);
//
// assertObjectFields(postgresObjectRequest, "brewery", "brewName",
// Origin.filtering(filterCriteria));
// }
//
// @Test
...
// postgresObjectRequest.addFields(filterCriteria);
//
// assertObjectFields(postgresObjectRequest, "brewery.address", "city",
// Origin.filtering(filterCriteria));
// }
//
// @Test
// void
// addFilterCriteria_createsNoObjectFields_forTwoLevelNestedFilterWhenObjectFieldsAlreadyExist() {
// var addressTypeConfiguration = createAddressTypeConfiguration();
// var breweryTypeCOnfiguration = createBreweryTypeConfiguration(addressTypeConfiguration);
// var beerTypeConfiguration = createBeerTypeConfiguration(breweryTypeCOnfiguration);
// var beerNameScalarField = createScalarField(beerTypeConfiguration.getFields()
...
// createObjectFieldForBrewery(beerTypeConfiguration, breweryTypeCOnfiguration,
...
// }
//
// private void assertObjectFields(PostgresObjectRequest objectRequest, String fieldPath, String
// fieldName,
// Origin origin) {
...
// {
// var objectField =
// getObjectField(objectRequest.getObjectFields(),
// fieldPaths[0]).orElseThrow(IllegalStateException::new);
//
...
// }
//
// private Optional<ObjectFieldConfiguration> getObjectField(List<ObjectFieldConfiguration>
// objectFields, String name) {
...
// }
//
// private PostgresTypeConfiguration createBeerTypeConfiguration(PostgresTypeConfiguration
// breweryTypeConfiguration) {
...
// }
//
// private PostgresTypeConfiguration createBreweryTypeConfiguration(PostgresTypeConfiguration
// addressTypeConfiguration) {
...
// }
//
// private ObjectFieldConfiguration createObjectFieldForBrewery(PostgresTypeConfiguration
// beerTypeConfiguration,
// PostgresTypeConfiguration breweryTypeConfiguration, PostgresTypeConfiguration
// addressTypeConfiguration) {
...
// .get("city");
//
// var addressObjectField = createObjectFieldConfiguration(addressFieldConfiguration,
// addressTypeConfiguration);
// addressObjectField.getObjectRequest()
// .addScalarField(createScalarField(cityFieldConfiguration));
//
// var breweryObjectField = createObjectFieldConfiguration(breweryFieldConfiguration,
// breweryTypeConfiguration);
...
// }
//
// private ObjectFieldConfiguration createObjectFieldConfiguration(PostgresFieldConfiguration
// fieldConfiguration,
