...
// Field<?> actualAggregateField = aggregateFieldFactory.create(joinAggregateFieldConfiguration,
// "beers", "name", "");
//
...
// @Test
// void
// create_returnsGroupConcatFieldOnColumnAlias_ForArgumentStringJoinWithDistinctTrueOnListTypeField()
// {
// var mockedFieldConfiguration = mock(FieldConfiguration.class);
// when(mockedFieldConfiguration.isList()).thenReturn(Boolean.TRUE);
// var joinAggregateFieldConfiguration =
...
// var sumAggregateFieldConfiguration = createAggregateFieldConfiguration(AggregateFunctionType.SUM,
// ScalarType.INT);
// Field<?> actualAggregateField =
// aggregateFieldFactory.create(sumAggregateFieldConfiguration, "beers", "soldPerYear", "");
//
// Field<?> expectedAggregateField = DSL.sum(DSL.field(DSL.name("beers", "soldPerYear"),
// BigDecimal.class))
// .cast(Integer.class);
// assertThat(actualAggregateField, is(expectedAggregateField));
// }
...
// var minAggregateFieldConfiguration = createAggregateFieldConfiguration(AggregateFunctionType.MIN,
// ScalarType.INT);
// Field<?> actualAggregateField =
// aggregateFieldFactory.create(minAggregateFieldConfiguration, "beers", "soldPerYear", "");
//
// Field<?> expectedAggregateField = DSL.min(DSL.field(DSL.name("beers", "soldPerYear"),
// BigDecimal.class))
// .cast(Integer.class);
// assertThat(actualAggregateField, is(expectedAggregateField));
// }
...
// var maxAggregateFieldConfiguration = createAggregateFieldConfiguration(AggregateFunctionType.MAX,
// ScalarType.INT);
// Field<?> actualAggregateField =
// aggregateFieldFactory.create(maxAggregateFieldConfiguration, "beers", "soldPerYear", "");
//
// Field<?> expectedAggregateField = DSL.max(DSL.field(DSL.name("beers", "soldPerYear"),
// BigDecimal.class))
// .cast(Integer.class);
// assertThat(actualAggregateField, is(expectedAggregateField));
// }
...
// var avgAggregateFieldConfiguration = createAggregateFieldConfiguration(AggregateFunctionType.AVG,
// ScalarType.INT);
// Field<?> actualAggregateField =
// aggregateFieldFactory.create(avgAggregateFieldConfiguration, "beers", "soldPerYear", "");
//
// Field<?> expectedAggregateField = DSL.avg(DSL.field(DSL.name("beers", "soldPerYear"),
// BigDecimal.class))
// .cast(Integer.class);
// assertThat(actualAggregateField, is(expectedAggregateField));
// }
...
// () -> aggregateFieldFactory.create(unknownTypeAggregateFieldConfiguration, "beers",
// "soldPerYear", ""));
// }
//
...
// }
//
// private AggregateFieldConfiguration createStringJoinAggregateFieldConfiguration(boolean
// isDistinct,
// String separator) {
// var mockedFieldConfiguration = mock(FieldConfiguration.class);
// return createStringJoinAggregateFieldConfiguration(mockedFieldConfiguration, isDistinct,
// separator);
// }
//
// private AggregateFieldConfiguration
// createStringJoinAggregateFieldConfiguration(FieldConfiguration fieldConfiguration,
// boolean isDistinct, String separator) {
// return createAggregateFieldConfiguration(fieldConfiguration, AggregateFunctionType.JOIN,
// ScalarType.STRING,
// isDistinct, separator, "");
// }
//
//
// private AggregateFieldConfiguration createAggregateFieldConfiguration(AggregateFunctionType
...
// var mockedFieldConfiguration = mock(FieldConfiguration.class);
// return createAggregateFieldConfiguration(mockedFieldConfiguration, aggregateFunctionType,
// scalarType, distinct,
// null, null);
// }
//
// private AggregateFieldConfiguration createAggregateFieldConfiguration(FieldConfiguration
// fieldConfiguration,
// AggregateFunctionType aggregateFunctionType, ScalarType scalarType, boolean distinct, String
// separator,
// String colunnAlias) {
