...
class SelectQueryBuilderTest {
  ...
  void buildObjectRequest_returnsQuery_forSingleFieldWithJoinTable() {
    ...
    ingredientFieldConfiguration.setName("code");
    ingredientFieldConfiguration.setColumn("code");
    ingredientFieldConfiguration.setType("String");

    var objectFieldConfiguration = ObjectFieldConfiguration.builder()
        .field(aggregatePostgresFieldConfiguration)
        .objectRequest(ObjectRequest.builder()
            .typeConfiguration(ingredientTypeConfiguration)
            .scalarFields(List.of(ScalarField.builder()
    ...
    var objectRequest = ObjectRequest.builder()
        ...
        .scalarFields(scalarFields)
        .objectFields(List.of(objectFieldConfiguration))
        .build();
