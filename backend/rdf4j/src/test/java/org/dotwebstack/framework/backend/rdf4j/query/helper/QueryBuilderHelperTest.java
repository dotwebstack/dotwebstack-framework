...
public class QueryBuilderHelperTest {
  ...
  public void buildWhereTriples_ReturnsTriple_forMultipleValues() {
    ...
    assertThat(triples.get(0)
        .getQueryString(),
        is(equalTo(
            "{ ?x0 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <https://github.com/dotwebstack/beer/def#Brewery> . } UNION { ?x0 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?x12 . }")));
  }
}
