...
class ValueFetcherTest {
  ...
  //
  // Model model = new ModelBuilder().add(BREWERY_EXAMPLE_1, BREWERY_IDENTIFIER_PATH,
  ...
  // ValueFetcher valueFetcher = new ValueFetcher(nodeShapeRegistry, converterRouter);
  //
  // Model model = new ModelBuilder().add(BREWERY_EXAMPLE_1, BREWERY_ADDRESS_PATH,
  // BREWERY_ADDRESS_EXAMPLE_1)
  ...
  // ValueFetcher valueFetcher = new ValueFetcher(nodeShapeRegistry, converterRouter);
  //
  // Model model = new ModelBuilder().add(BREWERY_EXAMPLE_1, BREWERY_OWNERS_PATH,
  ...
  // CoreMatchers.hasItems(BREWERY_OWNERS_EXAMPLE_1.stringValue(),
  // BREWERY_OWNERS_EXAMPLE_2.stringValue()));
  // }
  //
  // @Test
  ...
  // ValueFetcher valueFetcher = new ValueFetcher(nodeShapeRegistry, converterRouter);
  //
  // Model model = new ModelBuilder().add(BREWERY_EXAMPLE_1, BREWERY_FOUNDED_PATH,
  // BREWERY_FOUNDED_EXAMPLE_1)
  // .build();
  ...
  // // Arrange
  // BasePath propertyPath = PropertyPathFactoryTest.createPropertyPath(BREWERY_POSTAL_CODE_SHAPE);
  // PropertyShape propertyShape = PropertyShape.builder()
  ...
  // ValueFetcher valueFetcher = new ValueFetcher(nodeShapeRegistry, converterRouter);
  //
  // Model model = new ModelBuilder().add(BREWERY_EXAMPLE_1, SCHEMA_ADDRESS,
  // BREWERY_ADDRESS_EXAMPLE_1)
  ...
  // // Arrange
  // BasePath propertyPath = PropertyPathFactoryTest.createPropertyPath(BREWERY_BEERNAMES_SHAPE);
  // PropertyShape propertyShape = PropertyShape.builder()
  ...
  // // Arrange
  // BasePath propertyPath = PropertyPathFactoryTest.createPropertyPath(BREWERY_LABEL_PATH);
  ...
  // .build();
  //
  // Model model3 = new ModelBuilder().add(BREWERY_EXAMPLE_1, BREWERY_FOUNDED_PATH,
  // BREWERY_FOUNDED_EXAMPLE_1)
  // .build();
  //
  // // Act
  ...
  // // Arrange
  // BasePath propertyPath = PropertyPathFactoryTest.createPropertyPath(BEER_BEERTYPE_SHAPE);
  // PropertyShape propertyShape = PropertyShape.builder()
  ...
  // PropertyPathFactoryTest.createPropertyPath(BEER_BEERTYPE_ZERO_OR_MORE_SHAPE);
  // PropertyShape propertyShape = PropertyShape.builder()
  ...
  // // Arrange
  // BasePath propertyPath =
  // PropertyPathFactoryTest.createPropertyPath(BEER_BEERTYPE_ZERO_OR_ONE_SHAPE);
  // PropertyShape propertyShape = PropertyShape.builder()
