...
class CompareHelperTest {
  ...
  @Test
  void compareHelper_sortsList_withSimpleStringValue() {
    List<SimpleLiteral> ascending = List.of(new MemLiteral(null, "a"), new MemLiteral(null, "b"),
        new MemLiteral(null, "d"), new MemLiteral(null, "g"),
        new MemLiteral(null, "z"));

    List<SimpleLiteral> descending = List.of(new MemLiteral(null, "z"), new MemLiteral(null, "g"),
        new MemLiteral(null, "d"), new MemLiteral(null, "b"),
        new MemLiteral(null, "a"));

    List<SimpleLiteral> labels =
        new ArrayList<>(List.of(new MemLiteral(null, "a"), new MemLiteral(null, "z"),
            new MemLiteral(null, "g"), new MemLiteral(null, "d"),
            new MemLiteral(null, "b")));
  ...
  @Test
  void compareHelper_sortsList_withSimpleIntValue() {
    ...
    List<SimpleLiteral> labels =
        new ArrayList<>(List.of(int54, int1, int1230, int5, int102));
  ...
  @Test
  void compareHelper_sortsList_withSimpleDecimalValue() {
    ...
    List<SimpleLiteral> labels =
        new ArrayList<>(List.of(int54, int1, int1230, int5, int123, int503));
