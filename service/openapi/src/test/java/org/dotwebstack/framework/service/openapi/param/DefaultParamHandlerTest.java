...
public class DefaultParamHandlerTest {
  ...
  public void getValue_returnsValue_fromPathParam() throws ParameterValidationException {
    ...
    // Act
    Optional<Object> result = paramHandler.getValue(request, parameter, responseContext);
  ...
  public void getValue_throwsException_forArrayEnumCheck() {
    ...
    // Act / Assert
    assertThrows(ParameterValidationException.class, () -> paramHandler.getValue(request, parameter, responseContext));
  }
  ...
  public void getValue_throwsException_withArraytUnsupportedStyle() {
    ...
    // Act / Assert
    assertThrows(UnsupportedOperationException.class, () -> paramHandler.getValue(request, parameter, responseContext));
  }
