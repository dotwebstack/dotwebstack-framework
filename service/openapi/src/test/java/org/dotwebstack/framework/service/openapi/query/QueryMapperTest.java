...
class QueryMapperTest {
  ...
  static Stream<Arguments> arguments() {
    return Stream.of(Arguments.of("/breweries", MEDIA_TYPE_JSON, Map.of(), "brewery-collection"),
        ...
        Arguments.of("/breweries-pageable-with-params", MEDIA_TYPE_JSON, Map.of("page", "2", "pageSize", "42"),
            "brewery-pageable-collection-with-params"),
        Arguments.of("/breweries-pageable-with-params", MEDIA_TYPE_JSON_HAL, Map.of("page", "2", "pageSize", "42"),
            "brewery-pageable-collection-with-params"),
