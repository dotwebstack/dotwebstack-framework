...
// // Act / Assert
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("number",
// "String", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("number",
// "Boolean", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("number",
...
// // Act / Assert
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("integer",
// "Long", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("integer",
// "String", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("integer",
...
// // Act / Assert
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("boolean",
// "Long", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("boolean",
// "String", ""));
// assertThrows(InvalidConfigurationException.class, () -> this.validator.validateTypes("boolean",
...
// .get(path);
// List<ResponseTemplate> responses = ResponseTemplateBuilderTest.getResponseTemplates(this.openApi,
// path, methodName);
