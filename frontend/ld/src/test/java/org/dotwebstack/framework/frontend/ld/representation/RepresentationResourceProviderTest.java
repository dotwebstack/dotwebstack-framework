...
public class RepresentationResourceProviderTest {
  ...
  public void loadRepresentation() {
    ...
    when(graphQuery.evaluate()).thenReturn(new IteratingGraphQueryResult(ImmutableMap.of(),
        ImmutableList.of(
            valueFactory.createStatement(DBEERPEDIA.BREWERY_LIST_REPRESENTATION, RDF.TYPE, ELMO.REPRESENTATION),
            valueFactory.createStatement(DBEERPEDIA.BREWERY_LIST_REPRESENTATION, ELMO.INFORMATION_PRODUCT_PROP,
    ...
    Representation representation = representationResourceProvider.get(DBEERPEDIA.BREWERY_LIST_REPRESENTATION);
