...
public class DateSchemaMapperTest {
  ...
  public void mapGraphValue_ReturnsValue_WhenNoLdPathHasBeenSupplied() {
    // Act
    LocalDate result =
        schemaMapper.mapGraphValue(property, entityBuilderContext, schemaMapperAdapter, VALUE_1);
  ...
  public void mapGraphValue_ReturnsValue_ForLdPath() {
    ...
    // Act
    LocalDate result =
        schemaMapper.mapGraphValue(property, entityBuilderContext, schemaMapperAdapter, context);
