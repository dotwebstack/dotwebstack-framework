...
import org.dotwebstack.framework.frontend.openapi.entity.QueryEntity;
...
public class ArrayPropertyHandlerTest {
    ...
    public void collectionOfObjects() throws Exception {
        ...
        org.eclipse.rdf4j.query.QueryResult query = mock(org.eclipse.rdf4j.query.QueryResult.class);
        when(query.hasNext()).thenReturn(true);
        when(query.next()).thenReturn(new Object());
        QueryResult queryResult = QueryResult.builder().withQueryResultGraph(query).build();
