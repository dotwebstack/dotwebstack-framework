...
public class OpenApiExtensionTest {
  ...
  public void importDefinitions() throws IOException {
    ...
    // Assert
    verify(swaggerImporter).mapResources(httpConfiguration);
  }

  @Test
  public void importDefinitionsFailedIO() throws IOException {
    // Arrange
    doThrow(IOException.class).when(swaggerImporter).mapResources(httpConfiguration);
  ...
  public void importDefinitionsFailedConfiguration() throws IOException {
    // Arrange
    doThrow(ConfigurationException.class).when(swaggerImporter).mapResources(
        httpConfiguration);
