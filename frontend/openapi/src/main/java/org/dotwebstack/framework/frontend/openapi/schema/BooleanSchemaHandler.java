...
@Service
class BooleanSchemaHandler implements SchemaHandler<BooleanProperty, Boolean> {

  @Override
  public Boolean handleTupleValue(@NonNull BooleanProperty schema, @NonNull Value value) {
