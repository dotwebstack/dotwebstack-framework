...
public class DotWebStackRuntimeException extends RuntimeException {
  ...
  public DotWebStackRuntimeException(@NonNull String message, Object... arguments) {
    super(formatMessage(message, arguments), findCause(arguments));
  }

  DotWebStackRuntimeException(@NonNull String message, Throwable cause, Object... arguments) {
