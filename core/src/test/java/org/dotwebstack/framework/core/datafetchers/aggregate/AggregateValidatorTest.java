...
// FLOAT_MIN_FIELD, FLOAT_MAX_FIELD,
...
//
// var thrown =
// assertThrows(IllegalArgumentException.class, () -> validate(aggregateFieldConfiguration,
// selectedField));
//
// assertThat(thrown.getMessage(), is("Numeric aggregation for non-numeric field name is not
// supported."));
// }
//
// @Test
...
// selectedField));
//
// assertThat(thrown.getMessage(), is("String aggregation for non-text field soldPerYear is not
// supported."));
// }
// }
