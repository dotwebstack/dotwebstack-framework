...
// dwsReader.read("dotwebstack/dotwebstack-objecttypes-scalar-fields.yaml");
//
// var registry = graphqlConfiguration.typeDefinitionRegistry(dotWebStackConfiguration);
//
// assertThat(registry, is(notNullValue()));
...
// var dotWebStackConfiguration =
// dwsReader.read("dotwebstack/dotwebstack-objecttypes-complex-fields.yaml");
//
// var registry = graphqlConfiguration.typeDefinitionRegistry(dotWebStackConfiguration);
//
// assertThat(registry, is(notNullValue()));
...
// }
//
// private static void assertFieldDefinition(FieldDefinition fieldDefinition, String name, String
// type,
