...
//
// import static
// org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.DATE_FILTER_INPUT_OBJECT_TYPE;
// import static
// org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.DATE_TIME_FILTER_INPUT_OBJECT_TYPE;
// import static org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.EQ_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.FLOAT_FILTER_INPUT_OBJECT_TYPE;
...
// import static
// org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.INT_FILTER_INPUT_OBJECT_TYPE;
...
// import static
// org.dotwebstack.framework.core.datafetchers.filter.FilterConstants.STRING_FILTER_INPUT_OBJECT_TYPE;
...
//
// @ParameterizedTest
// @CsvSource({STRING_FILTER_INPUT_OBJECT_TYPE, DATE_FILTER_INPUT_OBJECT_TYPE,
// INT_FILTER_INPUT_OBJECT_TYPE,
...
// GraphQLInputObjectField inputObjectField = createInputObjectField(FIELD_TEST,
...
//
// @ParameterizedTest
// @CsvSource({"String, testString, eq", "Date, 2021-01-01, eq", "Int, 1234, eq", "Float, 12345,
// eq",
...
//
// assertThrows(IllegalArgumentException.class, () -> parser.parse(typeConfiguration,
// inputObjectField, data));
// }
//
// @Test
...
// GraphQLInputObjectField inputObjectField = createInputObjectField(FIELD_TEST,
// INT_FILTER_INPUT_OBJECT_TYPE);
// Map<String, Object> data = Map.of(FIELD_TEST, Map.of(NOT_FIELD, Map.of(EQ_FIELD, 1, LT_FIELD,
// 2)));
//
// List<FilterCriteria> result = parser.parse(typeConfiguration, inputObjectField, data);
//
...
// TypeConfigurationImpl typeConfiguration = createTypeConfiguration(INT_TYPE, Map.of(EQ_FIELD,
// 99));
// GraphQLInputObjectField inputObjectField = createInputObjectField(FIELD_DEFAULT_TEST,
// INT_FILTER_INPUT_OBJECT_TYPE);
...
// TypeConfigurationImpl typeConfiguration = createTypeConfiguration(INT_TYPE);
// GraphQLInputObjectField inputObjectField = createInputObjectField(FIELD_NULL_TEST,
// INT_FILTER_INPUT_OBJECT_TYPE);
