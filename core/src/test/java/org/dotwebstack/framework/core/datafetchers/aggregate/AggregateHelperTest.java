...
//
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.COUNT_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.FLOAT_AVG_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.FLOAT_MAX_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.FLOAT_MIN_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.FLOAT_SUM_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.INT_AVG_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.INT_MAX_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.INT_MIN_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.INT_SUM_FIELD;
// import static
// org.dotwebstack.framework.core.datafetchers.aggregate.AggregateConstants.STRING_JOIN_FIELD;
...
// getAggregateScalarType(selectedField));
//
...
//
// var thrown = assertThrows(IllegalArgumentException.class, () ->
// getAggregateFunctionType(selectedField));
//
// assertThat(thrown.getMessage(), is("Aggregate function intRange is not supported"));
// }
//
...
// arguments(INT_AVG_FIELD, AggregateFunctionType.AVG), arguments(INT_MAX_FIELD,
// AggregateFunctionType.MAX),
// arguments(INT_MIN_FIELD, AggregateFunctionType.MIN), arguments(INT_SUM_FIELD,
// AggregateFunctionType.SUM),
// arguments(FLOAT_AVG_FIELD, AggregateFunctionType.AVG), arguments(FLOAT_MIN_FIELD,
// AggregateFunctionType.MIN),
// arguments(FLOAT_MAX_FIELD, AggregateFunctionType.MAX), arguments(FLOAT_SUM_FIELD,
// AggregateFunctionType.SUM),
