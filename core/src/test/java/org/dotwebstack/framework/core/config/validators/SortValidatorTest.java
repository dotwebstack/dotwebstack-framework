...
// dwsReader.read("validators/dotwebstack-with-valid-sortable-by.yaml");
...
// var dotWebStackConfiguration =
// dwsReader.read("validators/dotwebstack-with-invalid-sortable-by.yaml");
// initObjectTypes(dotWebStackConfiguration);
// SortValidator validator = new SortValidator();
// var exception =
// assertThrows(InvalidConfigurationException.class, () ->
// validator.validate(dotWebStackConfiguration));
//
// assertThat(exception.getMessage(), is(
// "Sort field 'visitAddress.invalid' in object type 'Brewery' " + "can't be resolved to a single
// scalar type."));
// }
//
